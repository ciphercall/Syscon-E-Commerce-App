...
class SellerproductgalleryController extends Controller
{
    public function index()
    {
        ...
        return view("pages.backends.seller-products-gallery.index",["sellergallery"=>$sellergallery, "products"=>$products]);       
    }
    ...
    public function create()
    {
        $sellergallery=Productgallery::all();
        $products=Products::all();
        return view("pages.backends.seller-products-gallery.create",["sellergallery"=>$sellergallery, "products"=>$products]);
    }
    ...
    public function show($id){   
        ...
        return view("pages.backends.seller-products-gallery.index",["sellergallery"=>$sellergallery,"product"=>$product]);                
    }
