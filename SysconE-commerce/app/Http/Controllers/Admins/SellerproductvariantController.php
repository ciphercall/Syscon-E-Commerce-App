...
class SellerproductvariantController extends Controller
{
    public function index()
    {
        ...
        $sellervariant =DB::table('productvariants')
            ...
            ->get(); 
        return view("pages.backends.seller-products-variant.index",["sellervariant"=>$sellervariant, "products"=>$products, "statuses"=>$statuses]);       
    }
    ...
    public function create()
    {
        ...
        $products=Products::all();
        $statuses=Status::all();
        return view("pages.backends.seller-products-variant.create",["sellervariant"=>$sellervariant, "products"=>$products, "statuses"=>$statuses]);
    }
    ...
    public function show($id){ 
        ...
        return view("pages.backends.seller-products-variant.index",["sellervariant"=>$sellervariant,"product"=>$product, "statuses"=>$statuses]);                
    }
