    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-3">
                <div class="single_banner mb-30">
                    <div class="banner_thumb">
                        <a href="{{url('/shop')}}"><img src="{{url('frontends/assets/img/bg/banner1.jpg')}}" alt=""></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="single_banner mb-30">
                    <div class="banner_thumb">
                        <a href="{{url('/shop')}}"><img src="{{url('frontends/assets/img/bg/banner2.jpg')}}" alt=""></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="single_banner mb-30">
                    <div class="banner_thumb">
                        <a href="{{url('/shop')}}"><img src="{{url('frontends/assets/img/bg/banner4.jpg')}}" alt=""></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="single_banner mb-30">
                    <div class="banner_thumb">
                        <a href="{{url('/shop')}}"><img src="{{url('frontends/assets/img/bg/banner5.jpg')}}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <figure>
                        <div class="product_thumb">
                            <a class="primary_img" href="product-details.html"><img
                                    src="{{url('frontends/assets/img/product/product13.jpg')}}" alt=""></a>
                            <a class="secondary_img" href="product-details.html"><img
                                    src="{{url('frontends/assets/img/product/product14.jpg')}}" alt=""></a>
                            <div class="label_product">
                                <span class="label_sale">sale</span>
                            </div>
                        </div>
            ...
            <div class="col-lg-4">
                <article class="single_product">
                    <figure>
                        <div class="product_thumb">
                            <a class="primary_img" href="product-details.html"><img
                                    src="{{url('frontends/assets/img/product/product19.jpg')}}" alt=""></a>
                            <a class="secondary_img" href="product-details.html"><img
                                    src="{{url('frontends/assets/img/product/product20.jpg')}}" alt=""></a>
                            <div class="label_product">
                                <span class="label_sale">sale</span>
                            </div>
                        </div>
            ...
            <div class="col-lg-4">
                <article class="single_product">
                    <figure>
                        <div class="product_thumb">
                            <a class="primary_img" href="product-details.html"><img
                                    src="{{url('frontends/assets/img/product/product21.jpg')}}" alt=""></a>
                            <a class="secondary_img" href="product-details.html"><img
                                    src="{{url('frontends/assets/img/product/product22.jpg')}}" alt=""></a>
                        </div>
                        <figcaption class="product_content">
                            <div class="price_box">
                                <span class="current_price">$79.00</span>
            ...
            <div class="col-lg-4">
                <article class="single_product">
                    <figure>
                        <div class="product_thumb">
                            <a class="primary_img" href="product-details.html"><img
                                    src="{{url('frontends/assets/img/product/product23.jpg')}}" alt=""></a>
                            <a class="secondary_img" href="product-details.html"><img
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 col-md-9">
                <div class="single_banner mb-30">
                    <div class="banner_thumb">
                        <a href="shop.html"><img src="{{url('frontends/assets/img/bg/banner6.jpg')}}" alt=""></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3">
                <div class="single_banner mb-30">
                    <div class="banner_thumb">
                        <a href="shop.html"><img src="{{url('frontends/assets/img/bg/banner7.jpg')}}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="blog_carousel blog_column4 owl-carousel">
                    ...
                    <article class="single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="blog-details.html"><img src="{{url('frontends/assets/img/blog/blog1.jpg')}}" alt=""></a>
                            </div>
                ...
                <div class="col-lg-3">
                    <article class="single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="blog-details.html"><img src="{{url('frontends/assets/img/blog/blog2.jpg')}}" alt=""></a>
                            </div>
                            <figcaption class="blog_content">
                                <p class="post_author">By <a href="#">admin</a> July 04, 2021</p>
                ...
                <div class="col-lg-3">
                    <article class="single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="blog-details.html"><img src="{{url('frontends/assets/img/blog/blog3.jpg')}}" alt=""></a>
                            </div>
                            <figcaption class="blog_content">
                                <p class="post_author">By <a href="#">admin</a> July 04, 2021</p>
                ...
                <div class="col-lg-3">
                    <article class="single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="blog-details.html"><img src="{{url('frontends/assets/img/blog/blog4.jpg')}}" alt=""></a>
                            </div>
                            <figcaption class="blog_content">
                                <p class="post_author">By <a href="#">admin</a> July 04, 2021</p>
                ...
                <div class="col-lg-3">
                    <article class="single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="blog-details.html"><img src="{{url('frontends/assets/img/blog/blog5.jpg')}}" alt=""></a>
                            </div>
                            <figcaption class="blog_content">
                                <p class="post_author">By <a href="#">admin</a> July 04, 2021</p>
                ...
                <div class="brand_container owl-carousel">
                    <div class="brand_items">
                        <div class="single_brand">
                            <a href="#"><img src="{{url('frontends/assets/img/brand/brand1.jpg')}}" alt=""></a>
                        </div>
                        <div class="single_brand">
                            <a href="#"><img src="{{url('frontends/assets/img/brand/brand2.jpg')}}" alt=""></a>
                        </div>
                    </div>
                    <div class="brand_items">
                        <div class="single_brand">
                            <a href="#"><img src="{{url('frontends/assets/img/brand/brand3.jpg')}}" alt=""></a>
                        </div>
                        <div class="single_brand">
                            <a href="#"><img src="{{url('frontends/assets/img/brand/brand4.jpg')}}" alt=""></a>
                        </div>
                    </div>
                    <div class="brand_items">
                        <div class="single_brand">
                            <a href="#"><img src="{{url('frontends/assets/img/brand/brand5.jpg')}}" alt=""></a>
                        </div>
                        <div class="single_brand">
                            <a href="#"><img src="{{url('frontends/assets/img/brand/brand6.jpg')}}" alt=""></a>
                        </div>
                    </div>
                    <div class="brand_items">
                        <div class="single_brand">
                            <a href="#"><img src="{{url('frontends/assets/img/brand/brand7.jpg')}}" alt=""></a>
                        </div>
                        <div class="single_brand">
                            <a href="#"><img src="{{url('frontends/assets/img/brand/brand8.jpg')}}" alt=""></a>
                        </div>
                    </div>
                    <div class="brand_items">
                        <div class="single_brand">
                            <a href="#"><img src="{{url('frontends/assets/img/brand/brand9.jpg')}}" alt=""></a>
                        </div>
                        <div class="single_brand">
                            <a href="#"><img src="{{url('frontends/assets/img/brand/brand10.jpg')}}" alt=""></a>
                        </div>
                    </div>
                    <div class="brand_items">
                        <div class="single_brand">
