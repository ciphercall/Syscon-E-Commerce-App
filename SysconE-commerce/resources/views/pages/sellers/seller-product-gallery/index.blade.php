    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="{{url('seller/product')}}">Products</a></div>
            ...
            <div class="row mt-4">
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ URL::to('/seller/product-gallery') }}" method="POST" enctype="multipart/form-data">
                                @csrf                           
			...
			<div class="modal-body">
				...
				<div class="modal-btn delete-action">
					<div class="row float-right">
						<div class="col-6">
							<form action="{{url('delete-seller/product-gallery')}}" method="post" >
								@csrf
								@method("DELETE")
